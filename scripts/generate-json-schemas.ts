  ...
  software: makeSchema(
    ...
    ["name", "manufacturer"],
    {
      ...
      componentIdentifiers: {
        ...
        description:
          "Further identifiers for a product that ships more than one binary per format (a collection's members), keyed and resolved like `identifiers`, which keeps the primary.",
      },
      compatibleWith: {
        type: "array",
        items: { type: "string" },
