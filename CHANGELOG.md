...
- 41d4d76: Match every plugin a collection installs, and add the Pultec, StudioVerse, ROLI and sonible entries Studio kept reporting
...
- af4b938: Restore Kontakt compatibility on Impact Soundworks Plectra Series 1: 8-string Acoustic Bouzouki
...
- a6325a3: Refresh Tokyo Dawn Labs: 8 new, 0 discontinued, 20 updated.

  Adds Limen, Collector and six retired plugins including both Feedback
  Compressors and the vladg.net era Limiter N6, Molot and Nova-67P. Existing
  entries pick up current pricing, Linux builds and newer version numbers.

### Patch Changes

- c58ffaa: Refresh ToneBoosters: 0 new, 0 discontinued, 17 updated.

  Every entry gains current pricing, VST3 and iOS availability, fuller
  feature detail and version history. BitJuggler and Enhancer move to more
  specific primary categories.

- 05e6574: Backfill plugin formats and versions from a KVR Studio Manager scan: 9 formats
...
- 004e150: Close the eight open CodeRabbit security findings (four medium, four low).
...
- 54cab39: Add per-format identifiers and current versions for 34 software entries.
...
- a5dbb4e: Import Bondi Effects (6 hardware/software entries).
...
- c64f03b: Import Dean Markley (96 hardware/software entries).
- 7ec250d: Import Dekoni (143 hardware/software entries).
...
- 2243edb: Import Doboz (7 hardware/software entries).
- 9c8ceb5: Import dsp.coffee (6 hardware entries).
- dcd8b6d: Import Dutch & Dutch (11 hardware/software entries).
- 08a11b3: Import Echo Fix (80 hardware/software entries).
- 518153c: Import Electrosmith (5 hardware/software entries).
- a0e7aae: Import Embody (16 hardware/software entries).
- 437c902: Import Fieldtone (3 hardware entries).
- c8b7c92: Import Folktek (24 hardware/software entries).
- 2305084: Import Fulltone (29 hardware/software entries).
- 58bb4b3: Import Gospel Musicians (90 hardware/software entries).
- d845f35: Import Guru Gara Synth (59 hardware/software entries).
- 989c1f4: Import Hampshire Electronics (8 hardware/software entries).
- 51ab11d: Import Harmony (70 hardware/software entries).
- 2b15304: Import Herzlich Labs (113 hardware/software entries).
...
- 924998a: Import Instruments of Things (6 hardware and accessory entries).
- f13a527: Import ISOVOX (27 hardware/software entries).
- da77648: Import Italia (24 hardware entries).
- 111301d: Import Kiive Audio (22 software entries).
...
- 77fa3f2: Refresh LiquidSonics: 0 new, 0 discontinued, 12 updated.

  Brings the existing LiquidSonics reverb entries up to date with current
  descriptions, specs, formats, version history and pricing, and gives each
  one a more specific primary category.
